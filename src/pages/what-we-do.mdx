...
Terminal software comes pre-installed on every Apple, Linux, and Windows desktop ever sold.

In a [survey] of 1025 developers, 65% reported having have a terminal open _all day_ .
